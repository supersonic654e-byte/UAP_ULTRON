...
| Generation | Former name | Status | Role |
|---|---|---|---|
| Ultron_V0.1 | Robot_ODA_v1.0 | Retired | Laboratory / learning prototype |
| Ultron_V0.2 | Robot_ODA_v2.0 | Retired | Experimental / research prototype |
| Ultron_V0.3 | robot_odaV4 / 3rd build | **Current** | Final testing + pre-deployment prototype |
| Ultron_insightV1.0 | — | Planned | First real-world deployment version |
| Ultron_VitalsV2.0 / Ultron_MedAssistV3.0 | — | Planned | Future generations |
